<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Bprogram.aspx.cs" Inherits="Bonus_Bprogram" %>

<%@ Register assembly="FlashControl" namespace="Bewise.Web.UI.WebControls" tagprefix="Bewise" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <Bewise:FlashControl ID="FlashControl1" runat="server" Height="650px" 
    MovieUrl="~/Bonus/mcdonalds-eng.swf" Width="1000px" />
